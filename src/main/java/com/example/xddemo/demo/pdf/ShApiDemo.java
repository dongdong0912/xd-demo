...
public class ShApiDemo {
    ...
    public ShApiDemo(String appKey, String appSecret, String reqUrl) {
        this.appKey = appKey;
    ...
    public static void main(String[] args) {
        ShApiDemo clientV1Demo = new ShApiDemo("31560248", "66D11B7DFE4BF3BCD888DEC84E9CC666", "http://218.78.111.67:9090/router/rest");
