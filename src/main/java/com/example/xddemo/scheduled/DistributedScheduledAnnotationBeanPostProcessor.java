...
public class DistributedScheduledAnnotationBeanPostProcessor implements ScheduledTaskHolder, MergedBeanDefinitionPostProcessor, DestructionAwareBeanPostProcessor, Ordered, EmbeddedValueResolverAware, BeanNameAware, BeanFactoryAware, ApplicationContextAware, SmartInitializingSingleton, ApplicationListener<ContextRefreshedEvent>, DisposableBean {
    ...
    public DistributedScheduledAnnotationBeanPostProcessor(ScheduledTaskRegistrar registrar) {
    ...
    @Override
    public void postProcessMergedBeanDefinition(RootBeanDefinition beanDefinition, Class<?> beanType, String
            beanName) {
    }
            ...
            Map<Method, Set<DistributedScheduled>> annotatedMethods = MethodIntrospector.selectMethods(targetClass,
                    (MethodIntrospector.MetadataLookup<Set<DistributedScheduled>>) method -> {
                        Set<DistributedScheduled> scheduledMethods = AnnotatedElementUtils.getMergedRepeatableAnnotations(
                                method, DistributedScheduled.class);
     ...
     */
    protected void processScheduled(DistributedScheduled scheduled, Method method, Object bean) {
        try {
            ...
            if (StringUtils.hasText(cron)) {
                ...
                if (StringUtils.hasLength(cron)) {
                    ...
                    if (!DistributedScheduled.CRON_DISABLED.equals(cron)) {
                        TimeZone timeZone;
    ...
    protected Runnable createRunnable(Object target, Method method) {
        ...
        return new DistributedScheduledMethodRunnable(target, invocableMethod);
    }
